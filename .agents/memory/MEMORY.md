...
- [Item-assigned kitchen workflow](item-assigned-kitchen-workflow.md) — route kitchen work per item, but keep totals, service codes, serving completion, and payment on one parent order.
